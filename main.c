...
int mouse_x=0,mouse_y=0,olx=0,oly=0,prevb=0;
#endif
...
#ifndef PSP // We'll override this thank you
...
//          else
    ...
    i=SDL_JoystickGetHat(joy,0);
    if(i&SDL_HAT_RIGHT) mouse_x-=2;
    if(i&SDL_HAT_LEFT) mouse_x+=2;
    if(i&SDL_HAT_DOWN) mouse_y-=2;
    if(i&SDL_HAT_UP) mouse_y+=2;

    mouse_x+=SDL_JoystickGetAxis(joy,0)/9000;
    mouse_y+=SDL_JoystickGetAxis(joy,1)/9000;
